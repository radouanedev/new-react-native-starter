 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.rad.staging
 */

const BUNDLE_ID = 'com.rad' // ios bundle id
const PACKAGE = 'com.rad' // android package name
const NAME = 'RNRadApp' // app name
